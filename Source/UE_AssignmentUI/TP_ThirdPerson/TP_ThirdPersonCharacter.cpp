...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	static ConstructorHelpers::FObjectFinder<UPawnAttributeAsset> AssetFinder(TEXT("/Script/Assignment_1_2.PawnAttributeAsset'/Assignment_1_2/ThirdPersonAsset.ThirdPersonAsset'"));
	if (AssetFinder.Succeeded())
	{
		ThirdPersonAttributes = AssetFinder.Object;
	}
	//ThirdPersonAttributes->Health = 120;
}
