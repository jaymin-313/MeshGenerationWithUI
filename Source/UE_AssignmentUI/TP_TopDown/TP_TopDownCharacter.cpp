...
ATP_TopDownCharacter::ATP_TopDownCharacter()
{
	...
	static ConstructorHelpers::FObjectFinder<UPawnAttributeAsset> AssetFinder(TEXT("/Script/Assignment_1_2.PawnAttributeAsset'/Assignment_1_2/TopDawnAsset.TopDawnAsset'"));
